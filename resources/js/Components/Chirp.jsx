...
export default function Chirp({ chirp }) {
    ...
    return (
        <div className="p-6 flex space-x-2">
                    ...
                    {chirp.user.id === auth.user.id &&
                        <Dropdown>
                            ...
                            <Dropdown.Content>
                                ...
                                <button className="block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:bg-gray-100 transition duration-150 ease-in-out" onClick={addLike}>
                                    Like:{likeNumber}
                                    {/* {{$post->likeNumber}} */}
                                </button>
            ...
            <div>
                <button className=" hover:bg-gray-100 focus:bg-gray-100 " onClick={addLike}>
                    Like {likeNumber}
                </button>
            </div>
